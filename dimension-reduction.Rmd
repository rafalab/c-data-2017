...
Note that there is a strong correlation, but can we improve it? Furthermore, the actual distance is generally underestimated. This is actually to expected since we are adding more things in the actual distance. If instead we average and use this distance, 
